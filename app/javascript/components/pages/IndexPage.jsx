...
export default function IndexPage() {
  ...
  return (
    <div className="Index-page-container" style={{ padding: "1rem" }}>
        <div style={{ margin: "2rem 0", padding: "1rem", backgroundColor: "#f9f9f9", border: "1px dashed #ccc" }}>
         <h3>Market Trends (Selling Quantity Graph)</h3>
         <p style={{ color: "#888" }}>[ Bar Chart Component will render here: Textbooks | Furniture | Stationary | Snacks ]</p>
        </div>
        <div>Products</div>
